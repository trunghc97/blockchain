...
- **✅ Public-Private Network Separation**: Frontend + API Gateway = Public Network, blockchain-gw + peers + orderer = Private Blockchain Network
- **✅ Fabric Client Architecture**: blockchain-gw đóng vai trò Fabric Client trong Private Blockchain Network
